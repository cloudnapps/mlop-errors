module.exports = {
  ...
  requireAttachment:                  { code: 40019, message: 'require attachement'},
  requireAttachmentId:                { code: 40020, message: 'require attachement id'},
  failedToFindAttachment:             { code: 40021, message: 'failed to find attachement'},
  attachmentNotExist:                 { code: 40022, message: 'attachement not exist'},
  failedToCreateAttachement:          { code: 40023, message: 'failed to create attachement'},
  failedToUpdateAttachement:          { code: 40024, message: 'failed to update attachement'},
