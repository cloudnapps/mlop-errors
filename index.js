module.exports = {
  ...
  requireScenario:                    { code: 40024, message: 'require scenario'},
  requireScenarioId:                  { code: 40025, message: 'require scenario id'},
  failedToFindScenario:               { code: 40026, message: 'failed to find scenario'},
  scenarioNotExist:                   { code: 40027, message: 'scenario not exist'},
  failedToCreateScenario:             { code: 40028, message: 'failed to create scenario'},
  requireApp:                         { code: 40029, message: 'require app'},
