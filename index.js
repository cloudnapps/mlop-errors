module.exports = {
  ...
  requireScenario:                    { code: 40019, message: 'require scenario'},
  requireScenarioId:                  { code: 40020, message: 'require scenario id'},
  failedToFindScenario:               { code: 40021, message: 'failed to find scenario'},
  scenarioNotExist:                   { code: 40022, message: 'scenario not exist'},
